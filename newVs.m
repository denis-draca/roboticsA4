...
%Initial pose
q0 = [-0.0642    1.2331    0.3770    0.8555   -0.1257   -2.0944    1.0000];
...
r.model.plot(q0)
hold on;
helixModel = PartLoader('helix2.ply', modelLocation);
drawnow
...
while true
    ...
    J2 = r.model.jacob0(r.model.getpos);
    ...
    W = calcW(W, r.model,r.model.getpos,c);
